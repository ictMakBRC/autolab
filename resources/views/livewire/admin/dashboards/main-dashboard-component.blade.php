        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12 col-lg-8 col-xl-8 d-flex">
                    {{-- @json($labels)--> @json($currentYearSampleData)--> @json($previousYearSampleData) --}}
                    <div class="card radius-10 w-100">
                        <div class="card-body">
        ...
        @push('scripts')
            ...
            <script>
                $(function() {
                    ...
                    var chart = new ApexCharts(document.querySelector("#samplesChart"), options);
                    chart.render();
                    ...
                    var chart2 = new ApexCharts(document.querySelector("#testsChart"), options2);
                    chart2.render();
                    ...
                    var chart = new ApexCharts(document.querySelector("#chart6m6"), options);
                    chart.render();
