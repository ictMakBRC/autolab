                         ...
                         <div class="row row-cols-1 row-cols-lg-2 g-3 align-items-center">
                            ...
                            <div class="col">
                              <div class="d-flex align-items-center justify-content-sm-end gap-3 cursor-pointer">
                                 <div class="font-13"><i class="bi bi-circle-fill text-primary"></i><span class="ms-2">{{date('Y')}}</span></div>
                                 <div class="font-13"><i class="bi bi-circle-fill text-success"></i><span class="ms-2">{{date('Y')-1}}</span></div>
                              </div>
                            </div>
                         </div>
                         <div id="chart1"></div>
            ...
            <script>
                $(function() {
                    ...
                    var options = {
                        series: [{
                            name: "Current Year",
                            data: @json($currentYearSampleData??0)
                        },
                         {
                            name: "Previous Year",
                            data: @json($previousYearSampleData??0)
                        }
                    ],
                        chart: {
                            foreColor: '#9a9797',
