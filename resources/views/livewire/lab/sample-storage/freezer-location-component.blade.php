<div class="row">
                        ...
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-auto">
                                ...
                                <a type="button" class="btn btn-info" data-bs-toggle="modal"
                                    data-bs-target="#addFreezerLocation">Add Location</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-content">
                    <div class="table-responsive">
                        <table id="datableButton" class="table table-striped mb-0 w-100 sortable">
                            ...
                            <tbody>
                                @foreach ($freezerLocations as $key => $freezerLocation)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        ...
                                        @endif
                                        <td>{{ date('d-m-Y', strtotime($freezerLocation->created_at)) }}</td>
                                        <td class="table-action">
                                            <a href="javascript: void(0);" class="action-ico btn btn-outline-info mx-1">
                                                <i class="bi bi-pencil-square" data-bs-toggle="modal"
                                                    wire:click="editdata({{ $freezerLocation->id }})"
                                                    data-bs-target="#editfreezerLocation"></i></a>
                                            @if (Auth::user()->hasPermission(['master-access']))
                                                <a href="javascript: void(0);"
                                                    wire:click="deleteConfirmation({{ $freezerLocation->id }})"
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="btn-group float-end">
                                {{ $freezerLocations->links('vendor.livewire.bootstrap') }}
                            </div>
                        </div>
                    </div>
                </div> <!-- end tab-content-->
    ...
    {{-- ADD DESIGNATION --}}
    <div wire:ignore.self class="modal fade" id="addFreezerLocation" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add New Freezer Location</h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="storeData">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="freezerLocationName" class="form-label">Freezer Location Name</label>
                                    <input type="text" id="freezerLocationName" class="form-control" name="name"
    ...
    <div wire:ignore.self class="modal fade" id="delete_modal" tabindex="-1" data-backdrop="static"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Delete Freezer Location</h5>
    ...
    <div wire:ignore.self class="modal fade" id="editfreezerLocation" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Update Freezer Location</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                </div> <!-- end modal header -->
                <div class="modal-body">
    ...
    @push('scripts')
        <script>
            window.addEventListener('close-modal', event => {
                $('#addFreezerLocation').modal('hide');
                $('#editfreezerLocation').modal('hide');
                $('#delete_modal').modal('hide');
                $('#show-delete-confirmation-modal').modal('hide');
            });

            window.addEventListener('edit-modal', event => {
                $('#editfreezerLocation').modal('show');
            });
