                    ...
                    <table class="table table-bordered" id="dynamicoptions">
                        ...
                        @foreach ($testresults as $item)
                            <tr>                                
                                ...
                                <td> <a href="javascript:;" class="text-danger" data-bs-toggle="tooltip" wire:click="deleteConfirmation({{ $item->id }})"  title="Delete"><i class="bi bi-trash-fill"></i></a> </td>
                            </tr>
                        @endforeach
                        <tr>
                            <td>
                                <input type="text" name="possible_result" wire:model="possible_result" placeholder="Enter possible result" class="form-control" />
                                @error('possible_result')
                                <div class="text-danger text-small">{{$message}}</div>
                                @enderror
                            </td>
                            <td><button type="button" name="add" id="dynamic-resultsc" wire:click.prevent="storeResult()" class="btn btn-outline-primary">Add</button></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col  table-responsive">
                        <table class="table table-bordered">
                            ...
                            @foreach ($testsampletypes as $item)
                                <tr>                                
                                    <td>{{$item->sample}}</td>
                                    <td> <a href="javascript:;" class="text-danger" data-bs-toggle="tooltip" wire:click="deletesample({{ $item->id }})"  title="Delete"><i class="bi bi-trash-fill"></i></a> </td>
                                </tr>
                            @endforeach                           
                        </table>
                    </div>
                    <div class="col">
                        ...
                        <div class="text-danger text-small">{{$message}}</div>
                        @enderror
                        <select class="form-control" wire:model="sample" name="sample"  data-placeholder="Choose sample types">                            
                                <option value="">Select</option>
                            ...
                            <button type="button" name="add" id="sample" wire:click.prevent="storeSampleType()" class="btn btn-outline-primary mt-3 float-right text-end">Add</button>              
                    </div>                  
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($testcomments as $item)
                                <tr>                                
                                    <td>{{$item->comment}}</td>
                                    <td> <a href="javascript:;" class="text-danger" data-bs-toggle="tooltip" wire:click="deleteComment({{ $item->id }})"  title="Delete"><i class="bi bi-trash-fill"></i></a> </td>
                                </tr>
                            @endforeach
                            <tr>
                                <td>
                                    <input type="text" name="comment" wire:model="comment" placeholder="Enter new comment" class="form-control" />
                                    @error('comment')
                                    <div class="text-danger text-small">{{$message}}</div>
                                    @enderror
                                </td>
