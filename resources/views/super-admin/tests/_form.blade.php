            ...
            <div class="row">
                @if (isset($test))
                            ...
                            <table class="table table-bordered" id="dynamicoptions">
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" name="add" id="dynamic-resultsc"
                                            wire:click.prevent="storeResult()"
                    ...
                    @else
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col">
                                    <select name="type" onchange="reslutstype()" id="resultype"
                                        class="form-select" style="width: 100%; height:36px;" required>
                ...
                @else
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col">
                                <select name="type" onchange="reslutstype()" id="resultype" class="form-select"
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                @if (isset($test))
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <button type="button" name="add" id="sample"
                                wire:click.prevent="storeSampleType()"
                ...
                @else
                    <div class="row">
                        <div class="col table-responsive">
                            <select class="select2 m-b-10 select2-multiple form-control" name="sample_type[]"
                                style="width: 100%" multiple="multiple" data-placeholder="Choose sample types">
                                @if (count($sampletypes) > 0)
                                    @foreach ($sampletypes as $item)
                                        <option value="{{ $item->sample_name }}">{{ $item->sample_name }}</option>
                                    @endforeach
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" name="" id="dynamic-comment"
                                            wire:click.prevent="storecomment()"
                                            class="btn btn-outline-primary">Add</button></td>
                                </tr>
                            </table>
                        </div>
