...
<head>
    ...
    <style>
        ...
        /* Optional: Remove page break after the last report */
        .test-result:last-child {
            page-break-after: auto;
            /* No page break after the last one */
        }
...
<body style="line-height:1.2; font-family:times;">
    ...
    @foreach ($testResults as $testResult)
        <div class="report-wrapper test-result">
            ...
            <div class="col-12 table-responsive" style="font-size:15px; margin-top:20px; text-align: left">
                <table class="table dt-responsive nowrap" width="100%">
                    <tbody>
                        ...
                        <tr class="btop">
                            <td class="btop">
                                <div><b style="font-size: 18px">Test
                                        Requested:</b>{{ $testResult->test->name ?? 'N/A' }}
                                    <div>
                            </td>
